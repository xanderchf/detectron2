...
__all__ = ["load_bdd_json", "load_sem_seg"]


def load_bdd_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    """
...
def load_sem_seg(gt_root, image_root, gt_ext="png", image_ext="jpg", task_name="sem_seg"):
    """
    ...
    for (img_path, gt_path) in zip(input_files, gt_files):
        ...
        record["{}_file_name".format(task_name)] = gt_path
        dataset_dicts.append(record)
